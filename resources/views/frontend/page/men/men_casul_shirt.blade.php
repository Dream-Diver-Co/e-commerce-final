                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style="height: 300px; width: 300px;"  src="{{ asset('storage/' . $cshirt->image) }}" alt="">
                            <div class="product-action">
                                {{-- <a class="btn btn-outline-dark btn-square view-btn" data-name="{{ $cshirt->name }}"  data-price="459" data-image="{{ asset('storage/' . $cshirt->image) }}" data-miles="35,000 mi" data-transmission="Auto" data-hp="700 hp"><i class="fa fa-eye"></i></a> --}}
                                {{-- <a href="{{ route('product_details', $cshirt->id) }}" title="View Panjabi" class="btn btn-outline-dark btn-square">
                                    <i class="fa fa-eye"></i>
                                </a> --}}
                                <a href="#" class="btn btn-outline-dark btn-square view-item-btn"
                                    ...
                                    data-id="{{ $cshirt->id }}"
                                    data-name="{{ $cshirt->name }}"
                                    data-price="{{ $cshirt->price }}"
                                    data-image="{{ asset('storage/'. $cshirt->image) }}"
                                    data-subtitle="{{ $cshirt->subtitle }}"
                                    data-description="{{ $cshirt->description }}"
                                    data-information="{{ $cshirt->information }}">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{ $cshirt->name }}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>${{ $cshirt->price }}</h5><h6 class="text-muted ml-2"><del>$123.00</del></h6>
                            </div>
